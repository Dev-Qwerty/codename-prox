<template>
  <div class="Modal">
    <div class="Mbg">
      <div class="Mbox">
        <div class="Img">
          <router-link :to="{ path: '/services/carpentry' }" @click.native="closefn">
            <div class="cbtn"></div>
          </router-link>
        </div>
...
export default {
  ...
  methods: {
    ...
    cartfn(){
      EventBus.$emit("routepath", "/services/carpentry/ctmodal")
      this.$cookies.set("route", "/services/carpentry/ctmodal")
    },
    closefn() {
