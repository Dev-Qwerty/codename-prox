<template>
    <div>
        ...
        <div>
            <center>
                <router-link :to="{path: '/customerdashboard'}">
...
export default {
    ...
    created() {
        ...
        if(this.$cookies.get("s") == null) [
            this.$cookies.set("s", this.$route.query.r, '1d')
        ]
        this.respCode = this.$cookies.get("s")
